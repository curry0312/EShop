...
import { createShop, CreateShopParams } from "@/axios/(seller)/createShop";
...
export type CreateShopFormSchemaType = z.infer<typeof CreateShopFormSchema>;
...
CreateShopProps) {
  ...
  const createShopMutation = useMutation({
    mutationFn: (data: CreateShopParams) => createShop(data),
    onSuccess: (data) => {
      console.log(data);
