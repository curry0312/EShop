...
import CreateShop from "@/components/(seller)/modules/CreateShop";
import { COUNTRIES } from "@/libs/countries";
import {
  signupSeller,
  SignupSellerParams,
} from "@/axios/(seller)/signupSeller";
import {
  verifySeller,
  VerifySellerParams,
} from "@/axios/(seller)/verifySeller";
...
export default function Page() {
  ...
  const signupMutation = useMutation({
    mutationFn: (data: SignupSellerParams) => signupSeller(data),
  ...
  const verifyOtpMutation = useMutation({
    mutationFn: ({ sellerData, otp }: VerifySellerParams) =>
      verifySeller({ sellerData, otp }),
    onSuccess: (data) => {
  ...
  return (
    <div className="w-full py-10 min-h-screen bg-[#f1f1f1] text-black">
      {/*Stepper for signup*/}
