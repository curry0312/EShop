...
import { getDiscountCodes } from "@/axios/(seller)/getDiscountCodes";
import { createDiscountCode, CreateDiscountCodeParams } from "@/axios/(seller)/createDiscountCodes";
import { deleteDiscountCode } from "@/axios/(seller)/deleteDiscountCodes";
