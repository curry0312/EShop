...
import { loginSeller, LoginSellerParams } from "@/axios/(seller)/loginSeller";
...
export default function page() {
  ...
  const loginMutation = useMutation({
    mutationFn: ({ email, password}: LoginSellerParams) =>
      ...
      <div className="w-full flex justify-center">
        <div className="md:w-[480px] flex flex-col items-center p-8 bg-white shadow rounded-lg">
          ...
          <p className="text-center text-gray-500 mb-4">
            ...
            <Link href="/signup-seller" className="text-[#000099]">
              Sign up
            </Link>
          </p>
